...
AngMomPointsSquare.prototype = new drawUtils.Animator;
...
AngMomPointsSquare.prototype.draw = function(t) {
    ...
    drawUtils.drawAngMomAtPoint(ctx, x, y, vx, vy, "a", -2, 2, length, angMomRadius, dotSize, this.showAll || this.showAB || this.showAD, this.showAB || this.showAD, this.showAB || this.showAD);
    drawUtils.drawAngMomAtPoint(ctx, x, y, vx, vy, "b", 0, 2, length, angMomRadius, dotSize, this.showAll || this.showAB, this.showAB, this.showAB);
    drawUtils.drawAngMomAtPoint(ctx, x, y, vx, vy, "c", 2, 2, length, angMomRadius, dotSize, this.showAll, false);
    drawUtils.drawAngMomAtPoint(ctx, x, y, vx, vy, "d", -2, 0, length, angMomRadius, dotSize, this.showAll || this.showAD, this.showAD, this.showAD);
    drawUtils.drawAngMomAtPoint(ctx, x, y, vx, vy, "e", 0, 0, length, angMomRadius, dotSize, this.showAll, false);
