...
function Pendulum3D(canvasId) {
    ...
    this.tg = new prairieDraw3D.TG(canvasId);
    this.cube = new prairieDraw3D.Cube(this.tg, [0, 0.7, 1, 1]);
    this.angMom = new prairieDraw3D.Line(this.tg, vec3.create([0, 0, 0]), vec3.create([0, 0, 1]), [0.6, 0, 0, 1]);
    this.angMomArrowhead = new prairieDraw3D.Arrowhead(this.tg, [0.6, 0, 0, 1]);
    this.vel = new prairieDraw3D.Line(this.tg, vec3.create([0, 0, 0]), vec3.create([0, 0, 1]), [0, 0.6, 0, 1]);
    this.velArrowhead = new prairieDraw3D.Arrowhead(this.tg, [0, 0.6, 0, 1]);

    this.texO = new prairieDraw3D.ImagePlane(this.tg, "tex/O_rescaled.png");
    this.texP = new prairieDraw3D.ImagePlane(this.tg, "tex/P_rescaled.png");
    this.texv = new prairieDraw3D.ImagePlane(this.tg, "tex/v_rescaled.png");
    this.texH = new prairieDraw3D.ImagePlane(this.tg, "tex/H_rescaled.png");
    /*
    this.texO = new prairieDraw3D.ImagePlane(this.tg, "tex/O_outline_rescaled.png");
    this.texP = new prairieDraw3D.ImagePlane(this.tg, "tex/P_outline_rescaled.png");
    this.texv = new prairieDraw3D.ImagePlane(this.tg, "tex/v_outline_rescaled.png");
    this.texH = new prairieDraw3D.ImagePlane(this.tg, "tex/H_outline_rescaled.png");
    */
    this.square = new prairieDraw3D.Square(this.tg, [0, 0, 0, 0.4]);
    this.xAxis = new prairieDraw3D.Line(this.tg, vec3.create([-1, 0, 0]), vec3.create([1, 0, 0]), [0, 0, 0, 0.3]);
    this.yAxis = new prairieDraw3D.Line(this.tg, vec3.create([0, -1, 0]), vec3.create([0, 1, 0]), [0, 0, 0, 0.3]);
    this.zAxis = new prairieDraw3D.Line(this.tg, vec3.create([0, 0, -1]), vec3.create([0, 0, 1]), [0, 0, 0, 0.3]);

    prairieDraw.Animator.call(this, canvasId, true);
    this.start();
...
Pendulum3D.prototype = new prairieDraw.Animator;
