...
AngMomPointsCircle.prototype = new prairieDraw.Animator;
...
AngMomPointsCircle.prototype.draw = function(t) {
    ...
    prairieDraw.drawAngMomAtPoint(ctx, x, y, vx, vy, "a", -2, 2, length, angMomRadius, dotSize, this.showAE || this.showAll, this.showAE);
    prairieDraw.drawAngMomAtPoint(ctx, x, y, vx, vy, "b", 0, 2, length, angMomRadius, dotSize, this.showAll, false);
    prairieDraw.drawAngMomAtPoint(ctx, x, y, vx, vy, "c", 2, 2, length, angMomRadius, dotSize, this.showAll, false);
    prairieDraw.drawAngMomAtPoint(ctx, x, y, vx, vy, "d", -2, 0, length, angMomRadius, dotSize, this.showD || this.showAll, this.showD);
    prairieDraw.drawAngMomAtPoint(ctx, x, y, vx, vy, "e", 0, 0, length, angMomRadius, dotSize, this.showE || this.showAE || this.showAll, this.showE || this.showAE);
